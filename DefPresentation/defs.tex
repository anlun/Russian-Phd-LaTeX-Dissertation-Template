...
\newcommand\ARM{\mathrm{ARM}}
  ...
  \newcommand\Promise{\ensuremath{\mathrm{Promise}}}
  \newcommand\ARMpop{\ensuremath{\mathrm{ARMv8\;POP}}}
  \newcommand\ARMax{\ensuremath{\mathrm{ARMv8.3}}}
  \newcommand\OpCpp{\ensuremath{\mathrm{OpC\text{++}}}}

\newcommand{\tstamp}[1]{\mbox{\small\color{brown!60!black}\bf{#1}}}
\newcommand{\tstampWOsize}[1]{\mbox{{\color{magenta!60!black}\bf{#1}}$_{\tau}$}}
...
\newcommand{\writeReq}[2]{[#1]\leftarrow#2}
\newcommand{\readReq}[2]{#1\leftarrow[#2]}
