...
\newcommand{\possibleOutcomes}{Результаты в оригинальной модели C/C++11:}
\newcommand{\midTests}{
  \vspace{.2cm} \hrule \vspace{.2cm}
}

\section{Буферизация записи (store buffering, SB)}
\label{app:sb}
...
\section{Буферизация чтения (load buffering, LB)}
\label{app:lb}
...
\litmusTestStart{CoRR-rlx}{\tick}{History + Viewfronts}{
  В оригинальной модели C/C++11 возможны все результаты, соответствующие
