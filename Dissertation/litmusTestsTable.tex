...
\hline
\multicolumn{10}{|c|}{Корректность повторного чтения (\textsf{CoRR})\label{acr:corr}\ifext{, \S\ref{app:corr}}{}} \\
\hline
\textsf{rlx}      & \tick & &       & & &  & & & \tick\\ 
\textsf{rel-acq}  & \tick & &       & & &  & & & \tick\\ 

\hline
\multicolumn{10}{|c|}{Независимые чтения независимых записей (\textsf{IRIW})\label{acr:iriw}\ifext{, \S\ref{app:iriw}}{}} \\
\hline
\textsf{rlx}      & \tick & &       & & &  & & & \tick\\ 
\textsf{rel-acq}  & \tick & &       & & &  & & & \tick\\ 
\textsf{sc}       & \tick & & \tick & & &  & & & \tick\\ 
...
\hline
\multicolumn{10}{|c|}{Зависимость запись-чтение (\textsf{WRC})\label{acr:wrc}\ifext{, \S\ref{app:wrc}}{}} \\
\hline
\textsf{rlx}      & \tick & &       & & & &  & & \tick\\ 
\textsf{rel-acq}  & \tick & &       & & & &  & & \tick\\ 
...
\hline
\multicolumn{10}{|c|}{Независимые записи (\textsf{WR})\label{acr:wr}\ifext{, \S\ref{app:wr}}{}} \\
\hline
\textsf{rlx}      & \tick & &       & & \tick & & & & \tick\\ 
