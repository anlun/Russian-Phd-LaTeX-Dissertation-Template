...
каждого потока обещающей машины по указателю на следующий к исполнению экземпляр инструкции и
будем обозначать его $\p.\TSf(\tId).\cpath$.
...
Proofs of the lemmas can be found
  in the extended version of the paper \cite{Podkopaev-al:ECOOP17}.
