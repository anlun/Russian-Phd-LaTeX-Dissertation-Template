...
связаны отношением симуляции, и симулируемая машина (в нашем случае это ARM-машина)
...
Изначальное состояние ARM-машины имеет инициализирующие записи во все локации
...
Наша формализация ARM-машины имеет 12 правил перехода по состояниям.
...
\section{Выводы}
В главе рассмотрено доказательство корректности компиляции из обещающей
...
Тем не менее, доказательство может быть расширено и для других конструкций.
