...
бы ввести ограничения на спекулятивное исполнение программ, которого нет в модели.
...
Для этих отношений доказывается, что если состояния машин связаны $\simrelPre$, то существует
...
Ниже приведено неформальное описание правил переходов.
\begin{description}
...
В этом разделе вводится промежуточную машину \ARMt~, а также доказывается, что она симулирует
ARM-машину.
